...
class AdController extends Controller
{
    ...
    public function update(AdminAdUpdateRequest $request, string $id)
    {
        ...
        $articles_page_ad = $this->handleFileUpload($request, 'articles_page_ad');
        ...
        Ad::updateOrCreate(
            ...
            [
                ...
                'home_middle_ad' => !empty($home_middle_ad) ? $home_middle_ad : $ad->home_middle_ad,'view_page_ad' => !empty($view_page_ad) ? $view_page_ad : $ad->view_page_ad,'articles_page_ad' => !empty($articles_page_ad) ? $articles_page_ad : $ad->articles_page_ad,'side_bar_ad' => !empty($side_bar_ad) ? $side_bar_ad : $ad->side_bar_ad,
                ...
                'articles_page_ad_status' => $request->articles_page_ad_status == 1 ? 1 : 0,
                ...
                'articles_page_ad_url' => $request->articles_page_ad_url,
