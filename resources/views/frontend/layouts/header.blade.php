...
@endphp
{{--<div class="">--}}
{{--    <img src="{{asset('frontend/assets/images/ads.jpg')}}" style="height:100px;width:1410px" alt="ads">--}}
{{--</div>--}}
            ...
            <div class="row">
                <div class="col-sm-6 col-md-8">
                    <div class="topbar-left topbar-right d-flex">
                        ...
                        <div class="topbar-text ml-4" id="clock">
                            <script>
                ...
                <div class="collapse navbar-collapse justify-content-between" id="main_nav99">
                    <ul class="navbar-nav ml-auto ">
                        @foreach ($FeaturedCategories as $category)
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('articles', ['category' => $category->slug]) }}">{{ $category->name }}</a>
                            </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu animate fade-up">
                                ...
                                <li><a class="dropdown-item icon-arrow" href="{{ route('articles', ['category' => $category->slug]) }}"> {{ $category->name }}
                                    </a></li>
                                @endforeach
                ...
                <div class="modal-body">
                    <nav class="list-group list-group-flush">
                        <ul class="navbar-nav ">
                            @foreach ($FeaturedCategories as $category)
                            <li class="nav-item">
                                <a class="nav-link active text-dark" href="{{ route('articles', ['category' => $category->slug]) }}"> {{ $category->name }}</a>
                            </li>
                            @endforeach
