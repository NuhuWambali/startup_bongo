...
@section('meta_description', $articles->meta_description)
@section('meta_og_title', $articles->meta_title)
@section('meta_og_description', $articles->meta_description)
@section('meta_og_image', asset($articles->image))
@section('meta_tw_title', $articles->meta_title)
@section('meta_tw_description', $articles->meta_description)
@section('meta_tw_image', asset($articles->image))
<!-- End Setting metas -->
@section('content')
<section class="pb-80">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumbs bg-light mb-4">
                    ...
                    <li class="breadcrumbs__item">
                        <a href="javascript:;" class="breadcrumbs__url">{{ __('frontend.Articles') }}</a>
                    </li>
                </ul>
                <!-- end breadcrumb -->
            </div>
            <div class="col-md-8">
                    ...
                    <div class="wrap__article-detail-content">
                        <div class="total-views">
                            <div class="total-views-read">
                                {{ convertToKFormat($articles->views) }}
                                <span>
                                    {{ __('frontend.views') }}
                                </span>
                            </div>
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <a class="btn btn-social-o twitter" href="https://twitter.com/intent/tweet?text={{ $articles->title }}&url={{ url()->current() }}" target="_blank">
                                        <i class="fa fa-twitter"></i>
                                        <span>{{ __('frontend.twitter') }}</span>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a class="btn btn-social-o whatsapp" href="https://wa.me/?text={{ $articles->title }}%20{{ url()->current() }}" target="_blank">
                                        <i class="fa fa-whatsapp"></i>
                                        <span>{{ __('frontend.whatsapp') }}</span>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a class="btn btn-social-o telegram" href="https://t.me/share/url?url={{ url()->current() }}&text={{ $articles->title }}" target="_blank">
                                ...
                                <li class="list-inline-item">
                                    <a class="btn btn-linkedin-o linkedin" href="https://www.linkedin.com/shareArticle?mini=true&url={{ url()->current() }}&title={{ $articles->title }}" target="_blank">
                        ...
                        <p style="font-size:35 px" class="has-drop-cap-fluid">
                            {!! $articles->content !!}
                        </p>
                    </div>
                ...
                <div class="wrap__profile">
                    <div class="wrap__profile-author">
                        <figure>
                            <img style="width: 200px;height: 200px;object-fit: cover;" src="{{ asset($articles->author->image) }}" alt="" class="img-fluid rounded-circle">
                        </figure>
                        <div class="wrap__profile-author-detail">
                            <div class="author-wrapper">
                                <div class="wrap__profile-author-detail-name">{{ $articles->author->getRoleNames()->first() }}</div>
                            <h4>{{ $articles->author->name }}</h4>
                ...
                <div id="comments" class="comments-area">
                    <h3 class="comments-title">{{ $articles->comments()->count() }} {{ __('frontend.Comments:') }}</h3>

                    <ol class="comment-list">
                        @foreach ($articles->comments()->whereNull('parent_id')->get() as $comment)
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('articles-comment-replay') }}" method="POST">
                                                @csrf
                    ...
                    <div class="comment-respond">
                        ...
                        <form action="{{ route('articles-comment') }}" method="POST" class="comment-form">
                            @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="single_navigation-prev">
                            @if ($previousPost)
                            <a href="{{ route('articles-details', $previousPost->slug) }}">
                    ...
                    <div class="col-md-6">
                        <div class="single_navigation-next text-left text-md-right">
                            @if ($nextPost)
                            <a href="{{ route('articles-details', $nextPost->slug) }}">
                        ...
                        <div class="wrapper__list__article-small">
                                                ...
                                                <ul class="list-inline">
                                                    <li class="list-inline-item">
                                                        <span class="text-primary">
                                                            {{ __('frontend.by') }} {{ $article->author->name }}
                                                        </span>
                                                    </li>
                                                    <li class="list-inline-item">
                                                        <span class="text-dark text-capitalize">
                            ...
                            <div class="article__entry">
                                ...
                                <div class="article__content" >
                                    ...
                                    <a href="{{ route('articles-details', $article->slug) }}" class="btn btn-outline-primary mb-4 text-capitalize"> {{ __('frontend.read more') }}</a>
                                </div>
                            </div>
                            @endif
                            @endforeach
        ...
        $('.delete-msg').on('click', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            method: 'DELETE',
                            url: "{{ route('articles-comment-destroy') }}",
                            data:{id:id},
