...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="index.html">Startup Bongo</a>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            @if (canAccess(['articles index']))
                <li class="dropdown {{ setSidebarActive(['admin.articles.*', 'admin.pending.articles']) }}">
                    <a href="#" class="nav-link has-dropdown"><i class="fas fa-newspaper"></i>
                        <span>{{ __('admin.Articles') }}</span></a>
                    <ul class="dropdown-menu">
                        <li class="{{ setSidebarActive(['admin.articles.*']) }}"><a class="nav-link"
                                href="{{ route('admin.articles.index') }}">{{ __('admin.All Articles') }}</a></li>

                        <li class="{{ setSidebarActive(['admin.pending.articles']) }}"><a class="nav-link"
                                href="{{ route('admin.pending.articles') }}">{{ __('admin.Pending Articles') }}</a></li>
