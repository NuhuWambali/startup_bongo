...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function(){
    ...
    /** News Route */
    Route::get('fetch-articles-category', [ArticlesController::class, 'fetchCategory'])->name('fetch-articles-category');
    Route::get('toggle-articles-status', [ArticlesController::class, 'toggleArticlesStatus'])->name('toggle-articles-status');
    // Route::get('articles-copy/{id}', [ArticlesController::class, 'copyNews'])->name('articles-copy');
    Route::get('pending-articles', [ArticlesController::class, 'pendingArticles'])->name('pending.articles');
    Route::put('approve-articles', [ArticlesController::class, 'approveArticles'])->name('approve.articles');
